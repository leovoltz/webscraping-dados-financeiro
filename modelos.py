...
class Estrategia:
    def __init__(self, segmento = "", cotacao_atual_minima = 0, ffo_yield_minimo = 0, dividiend_yield_minimo = 0,
                 valor_mercado_minimo = 0, liquidez_minima = 0, qt_minima_imoveis = 0, valor_minimo_preco_m2 = 0,
                 valor_minimo_aluguel_m2 = 0, valor_minimo_cap_rate = 0, maxima_vacancia_media = 0, p_vp_minimo = 0):
        self.segmento = segmento
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.preco_m2 < self.cotacao_atual_minima\
                or fundo.p_vp < self.p_vp_minimo\
                or fundo.dividend_yield < self.dividiend_yield_minimo\
